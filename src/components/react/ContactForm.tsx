        ...
        <section id="contacto" className="py-20 bg-black-900 rounded-xl shadow-xl ">
            ...
            <div className="text-center py-4 px-4 max-w-2xl mx-auto">
                <p className="text-white/70 mb-5">
                    ¿Tienes preguntas o quieres reservar nuestros servicios para tu próximo evento? ¡Estamos aquí para ayudarte!  contáctanos directamente a través de WhatsApp o Instagram. ¡Esperamos saber de ti pronto!
                </p>
...
"
                ...
                {/* Redes sociales 
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-white/70 hover:text-amber-400 transition-transform duration-200 hover:scale-110"
                    >
                        <Instagram className="w-8 h-8" />
                    </a>
