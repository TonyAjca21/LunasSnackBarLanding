...
const mockServicios = [
  {
    ...
    // Catering evento real :contentReference[oaicite:1]{index=1}
  ...
  },
  {
    id: "srv-002",
    image: "https://images.pexels.com/photos/769289/pexels-photo-769289.jpeg",
    // Mesa y vajilla de evento :contentReference[oaicite:2]{index=2}
  ...
  {
    id: "srv-003",
    image: "https://images.pexels.com/photos/857869/pexels-photo-857869.jpeg",
    // Chef preparando catering :contentReference[oaicite:3]{index=3}
...
const mockEventos = [
  {
    ...
    // Conferencia / evento tech real :contentReference[oaicite:4]{index=4}
    ...
    estado: true,
    fotos: [
      "https://images.pexels.com/photos/1181368/pexels-photo-1181368.jpeg",
  ...
  },
  {
    ...
    // Taller evento real :contentReference[oaicite:6]{index=6}
  ...
  {
    id: "evt-003",
    image: "https://images.pexels.com/photos/960309/pexels-photo-960309.jpeg",
    // Festival gastronomico real :contentReference[oaicite:7]{index=7}
...
export { mockServicios as a, howitworksSteps as h, mockEventos as m };
