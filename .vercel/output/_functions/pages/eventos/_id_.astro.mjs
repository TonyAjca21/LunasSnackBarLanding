import { e as createComponent, f as createAstro, m as maybeRenderHead, n as renderComponent, r as renderTemplate } from '../../chunks/astro/server_BMjgO3qf.mjs';
import 'piccolore';
...
function EventosId({ id }) {
  ...
  if (!evento) return /* @__PURE__ */ jsx("p", { children: "Cargando evento..." });
