import { e as createComponent, f as createAstro, h as addAttribute, k as renderScript, l as renderHead, n as renderComponent, r as renderTemplate } from '../chunks/astro/server_BMjgO3qf.mjs';
import 'piccolore';
/* empty css                                 */
import { jsxs, jsx } from 'react/jsx-runtime';
import { useState, useEffect } from 'react';
import { onAuthStateChanged, signOut, signInWithEmailAndPassword } from 'firebase/auth';
import { s as storage, d as db, a as auth } from '../chunks/firebase_Yv__SiKP.mjs';
...
const $$Admin = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Admin;
  return renderTemplate`<html lang="en"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>Lunas snack Bar</title><link rel="stylesheet" href="https://unpkg.com/swiper/swiper-bundle.min.css">${renderScript($$result, "C:/Users/Tony Castro/Desktop/Proyecto/LunasSnackBarLanding/LunasSnackBar/src/pages/admin.astro?astro&type=script&index=0&lang.ts")}${renderHead()}</head> <body> ${renderComponent($$result, "AdminEntry", AdminEntry, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/Tony Castro/Desktop/Proyecto/LunasSnackBarLanding/LunasSnackBar/src/components/admin/adminEntry", "client:component-export": "default" })} </body></html>`;
}, "C:/Users/Tony Castro/Desktop/Proyecto/LunasSnackBarLanding/LunasSnackBar/src/pages/admin.astro", void 0);

const $$file = "C:/Users/Tony Castro/Desktop/Proyecto/LunasSnackBarLanding/LunasSnackBar/src/pages/admin.astro";
const $$url = "/admin";
