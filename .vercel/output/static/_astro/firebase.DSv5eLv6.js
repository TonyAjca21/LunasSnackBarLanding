import{r as $,_ as Re,C as we,S as Te,c as ke,F as ye,l as ee,d as P,m as Ee,y as Ae,k as te,p as Ue,u as Oe,z as Ie,A as Ne,B as Ce}from"./index.esm.G7QU6KF7.js";import{g as Pe}from"./index-36fcbc82.CrNCpNEF.js";import{getFirestore as De}from"./index.esm.D1NI0F1c.js";var xe="firebase",Se="12.8.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ne="firebasestorage.googleapis.com",se="storageBucket",ve=120*1e3,Le=600*1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class O{constructor(t,n){this._service=t,n instanceof g?this._location=n:this._location=g.makeFromUrl(n,t.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(t,n){return new O(t,n)}get root(){const t=new g(this._location.bucket,"");return this._newRef(this._service,t)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return le(this._location.path)}get storage(){return this._service}get parent(){const t=bt(this._location.path);if(t===null)return null;const n=new g(this._location.bucket,t);return new O(this._service,n)}_throwIfRoot(t){if(this._location.path==="")throw Ye(t)}}function vt(e,t,n){e._throwIfRoot("uploadBytes");const s=Dt(e.storage,e._location,he(),new E(t,!0),n);return e.storage.makeRequestWithTokens(s,W).then(r=>({metadata:r,ref:e}))}function Lt(e){e._throwIfRoot("getDownloadURL");const t=It(e.storage,e._location,he());return e.storage.makeRequestWithTokens(t,W).then(n=>{if(n===null)throw Xe();return n})}function Bt(e){e._throwIfRoot("deleteObject");const t=Nt(e.storage,e._location);return e.storage.makeRequestWithTokens(t,W)}function Ft(e,t){const n=Rt(e._location.path,t),s=new g(e._location.bucket,n);return new O(e.storage,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const me="storage";function en(e,t,n){return e=P(e),vt(e,t,n)}function tn(e){return e=P(e),Lt(e)}function nn(e){return e=P(e),Bt(e)}function sn(e,t){return e=P(e),Ht(e,t)}function Vt(e=ee(),t){e=P(e);const s=Ee(e,me).getImmediate({identifier:t}),r=Ae("storage");return r&&qt(s,...r),s}function qt(e,t,n,s={}){jt(e,t,n,s)}function zt(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return new K(n,s,r,t,Te)}function Wt(){Re(new we(me,zt,"PUBLIC").setMultipleInstances(!0)),$(Z,Q,""),$(Z,Q,"esm2020")}Wt();const Kt={apiKey:"AIzaSyBLHkUNwVE3JYdRdtihYp1iSJQcpaKFMog",authDomain:"lunas-snack-bar.firebaseapp.com",projectId:"lunas-snack-bar",appId:"1:652966154220:web:95203befeb9947579c3ac9",storageBucket:"lunas-snack-bar.firebasestorage.app",messagingSenderId:"652966154220"},X=Ne().length?ee():Ce(Kt),Xt=Pe(X),Gt=De(X),Yt=Vt(X),rn=Object.freeze(Object.defineProperty({__proto__:null,auth:Xt,db:Gt,storage:Yt},Symbol.toStringTag,{value:"Module"}));export{nn as a,Xt as b,Gt as d,rn as f,tn as g,sn as r,Yt as s,en as u};
